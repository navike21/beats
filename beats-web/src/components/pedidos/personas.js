    ...
    return (
      <div className="w_100">
        ...
        <div className="w_100 section_middle_center full_min_h pedidosBeats spaceInBottom_normal">
          <div className="wrappBussiness section_middle_center whiteColor w_80 w_84_desktop">
            ...
            <div className="w_100 section_middle_center">
              <Slider {...settingsSlider}>
                ...
                <Link to="/pedido/personas/beats-love" className="options">
                  <div className="section_middle_center w_100 backgroundImg">
                ...
                <Link to="/pedido/personas/los-beats" className="options">
                  <div className="section_middle_center w_100 backgroundImg">
                ...
                <Link to="/pedido/personas/habla-beats" className="options">
                  <div className="section_middle_center w_100 backgroundImg">
