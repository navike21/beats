...
export default class AniversarioSocial extends Component {
  ...
  _sendFrm = () =>{
    ...
    let detailPedido = '<p><strong>Tipo de Aniversario: </strong> '+this.state.tipoAniversario+'</p> <p><strong>Fecha: </strong>'+this.state.fecha+'</p> <p><strong>Datos a Resaltar: </strong>'+this.state.resaltar+'</p>';
