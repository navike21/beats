...
export default class Mascota extends Component {
  ...
  _sendFrm = () =>{
    ...
    let detailPedido = '<p><strong>Nombre de la Mascota: </strong> '+this.state.nombreMascota+' </p> <p><strong>Edad: </strong> '+this.state.edad+' </p> <p><strong>Raza: </strong> '+this.state.raza+' </p> <p><strong>Datos a Resaltar: </strong> '+this.state.resaltar+' </p>'
